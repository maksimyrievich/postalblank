...
use app\components\RulesTableWidget;
use yii\widgets\Breadcrumbs;
use app\assets\AccordionViewSmartyAsset;

$this->title = 'Мой кабинет';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => '/account/saverule.html'];
$this->title = 'Стандартные правила';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => '/account/saverule.html'];
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <div class=" panel" style=" padding: 0px; background-color: #269abc" >
                    <div class=" panel" style="margin: 0px 0px 0px 0px">
                        <div class="panel-primary">
                            <div class="panel-heading" style="text-align: center">
                                Настройки выдачи бланков для созданных правил доставки
                            </div>
                            <?= RulesTableWidget::widget() ?>
                        </div>
                    </div>
                </div>
            </div>
